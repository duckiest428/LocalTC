...
PAGES = ["index.html", "dashboard.html", "support.html", "privacy.html", "terms.html", "cookies.html"]
...
def test_every_page_has_the_same_header_links():
    for page in PAGES:
        ...
        assert 'href="support.html"' in header, page
    ...
    assert ">Dashboard</a>" in template and 'href="support.html"' in template and ">Logbook</a>" not in template
